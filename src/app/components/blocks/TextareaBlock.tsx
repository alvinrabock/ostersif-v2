...
export default function TextareaBlock({ block, blockId }: TextareaBlockProps) {
  ...
  return (
    <div
      className="textarea-block leading-relaxed [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:space-y-2 [&_ol]:list-decimal [&_ol]:pl-6 [&_ol]:space-y-2 [&_li]:mb-1 [&_p]:leading-relaxed [&_p]:mb-4 [&_p:last-child]:mb-0"
