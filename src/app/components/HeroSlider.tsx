...
export default function HeroSlider({ maxPosts = 5 }: HeroSliderProps) {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        // Fetch posts with visaPaHemsida flag from Frontspace
        const response = await fetch(`/api/posts/featured?limit=${maxPosts}`);
